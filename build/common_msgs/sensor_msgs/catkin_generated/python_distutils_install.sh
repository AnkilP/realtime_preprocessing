...
echo_and_run cd "/home/ankilp/image_processing/src/common_msgs/sensor_msgs"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/ankilp/image_processing/src/common_msgs/sensor_msgs/setup.py" \
    build --build-base "/home/ankilp/image_processing/build/common_msgs/sensor_msgs" \
    install \
    $DESTDIR_ARG \
