...
echo_and_run cd "/home/ankilp/image_processing/src/vision_opencv/image_geometry"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/ankilp/image_processing/src/vision_opencv/image_geometry/setup.py" \
    build --build-base "/home/ankilp/image_processing/build/vision_opencv/image_geometry" \
    install \
    $DESTDIR_ARG \
