...
echo_and_run cd "/home/ankilp/image_processing/src/vision_opencv/cv_bridge"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python" \
    "/home/ankilp/image_processing/src/vision_opencv/cv_bridge/setup.py" \
    build --build-base "/home/ankilp/image_processing/build/vision_opencv/cv_bridge" \
    install \
    $DESTDIR_ARG \
